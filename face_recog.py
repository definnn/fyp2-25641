...
# python3 recognize_faces_video(copy).py --encodings encoding/encodings.pickle --output output/webcam_face_recognition_output.avi --display 1
...
def recognize_faces(input_encodings,input_write,input_display,input_duration):
    ...
    stream = cv2.VideoCapture("/media/ubuntu/USBEE1-11/sample1.mp4")
    writer = None
